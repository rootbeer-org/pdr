return {
    ...
    prebuilt = { github = "lsd-rs/lsd", tag = "v{version}", asset = "lsd-{tag}-{target}.tar.gz" },
    outputs = { bins = { "lsd" }, checks = { { "lsd", "--version" } } },
    platforms = {
        ["aarch64-linux"] = {
            target = "aarch64-unknown-linux-musl",
            default_version = "1.2.0",
            upstream = { github = "lsd-rs/lsd", repository_id = 158927812, tag_prefix = "v" },
        },
        ["aarch64-macos"] = {
